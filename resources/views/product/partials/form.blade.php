...
<div class="mb-3">
    ...
    <input type="text" name="description" class="form-control" 
        id="InputDescription" value="{{$product->description ?? old('name')}}"
    >
</div>
<div class="mb-3">
    <label for="InputValue" class="form-label">Value</label>
    <input type="number" name="value" class="form-control" 
        id="InputValue" value="{{$product->value ?? old('name')}}"
    >
</div>
<div class="mb-3">
    ...
    <input type="text" name="unit_of_measure" class="form-control" 
        id="InputUnitOfMeasure" value="{{$product->unit_of_measure ?? old('name')}}"
    >
</div>
