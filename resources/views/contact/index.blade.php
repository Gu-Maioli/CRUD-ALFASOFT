    ...
    <div class="container">
      ...
      <form action="{{route('create')}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="email" value="{{old('email')}}" class="form-control" id="InputEmail" name="email">
        </div>
        <div class="mb-3">
          <label for="InputContact" class="form-label" >Contact</label>
          <input type="number" value="{{old('contact')}}" class="form-control" name="contact" id="InputContact">
        </div>
        <a href="{{ route('index') }}">
